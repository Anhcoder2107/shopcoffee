...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="views/styles/css/auth/page-misc.css">
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <a href="<?php echo APPURL; ?>" class="btn btn-primary">Back to home</a>
            <div class="mt-3">
                <img src="views/styles/image/auth/page-misc-error-light.png" alt="page-misc-error-light" width="500"
