                        ...
                        <form id="formAuthentication" class="mb-3" action="" method="POST">
                            ...
                            <div class="mb-3 form-password-toggle">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?php //APPURL ?>forgotPassword">
...
<script>
    ...
    function togglePassword() {
        var x = document.getElementById("InputPassWord password");
        if (x.type === "password") {
            x.type = "text";
        } else {
            x.type = "password";
    ...
    //   var password = document.getElementById("InputPassWord password").value;
    ...
    //    }
    //}
    //document.getElementById("submit").onclick = checkRemember;
